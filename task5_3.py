...
if __name__ == "__main__":
    ...
    num_workers = 1
    cuda = torch.cuda.is_available()
    train_dataset = datasetaug.AudioDataset("{}training128mel{}.pkl".format(pkl_dir,  1), "ESC",
                                            transforms=None)
    test_dataset = datasetaug.AudioDataset("{}validation128mel{}.pkl".format(pkl_dir,  1), "ESC", mode=None)
